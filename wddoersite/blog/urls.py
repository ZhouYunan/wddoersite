...
urlpatterns = [
    ...
    url(r'^wddoer_admin/$', views.WddoerAdminView.as_view(), name='wddoer_admin_index'),
    url(r'^blog/category/create/$', views.CategoryCreateView.as_view(), name='category_create'),
]
